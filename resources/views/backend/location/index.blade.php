...
@section('main')
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="d-flex justify-content-end mb-2">
                   ...
                   <button type="button" class="btn btn-primary btn-sm d-flex align-items-center gap-1 text-dark" data-bs-toggle="modal" data-bs-target="#addLocationModal">
                                ...
                                @if($location->isNotEmpty())
                                    @foreach($location as $key => $location)
                                        <tr>
                                            ...
                                            <td>{{ $location->name }}</td>
                                            <td>
                                              <a class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editLocationModal{{ $location->id }}">
